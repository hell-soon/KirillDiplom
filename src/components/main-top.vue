  ...
  <nav class="menu-top">
    <header>
      ...
      <div class="menu-icons">
        <span class="text_nickname" @click="showModal">{{ isAuth ? 'Профиль' : 'Авторизация' }}</span>
          ...
          <div class="login-box">
            ...
            <div v-show="!registration" class="text-write_container">
              <div class="text-write">
                <input v-model="login" class="text_search_log" type="search" placeholder="Логин">
              </div>
              <div class="text-write_2">
                <input v-model="password" class="text_search_log" type="search" placeholder="Пароль">
              </div>
            </div>
            <div v-show="registration" class="text-write_container">
              <div class="text-write">
              ...
              <div class="text-write_2">
                <input
                  v-model="password" class="text_search_log" type="search"
                  placeholder="Пароль"
                  required
                >
              </div>
            ...
            <div class="button-log">
              <button class="button" @click="loginRequest">
                Войти
              </button>
              <button class="button">
                Регистрация
